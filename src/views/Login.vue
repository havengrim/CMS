        ...
        <div class="p-4 sm:p-6">
          <div class="text-center">
            <div class="flex flex-col items-center">
              <img class="w-12 sm:w-14 h-auto" :src="images.logo" alt="Logo" />
              <span class="font-bold text-lg sm:text-xl mt-4">Contract Management System</span>
            </div>
            <p class="mt-3 text-gray-500 dark:text-gray-300 text-sm sm:text-base">
